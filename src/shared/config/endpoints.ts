export const API_ENDPOINTS = {
  ACCOUNT: {
    GET_BY_ID: (userId: number | string) => `/account-service/api/users/${userId}`,
  ...
  TRANSACTIONS: {
    ...
    GET_BY_ID: (id: number | string) => `/transactions/${id}`,
    POST: "/transaction-service/api/v1/transactions",
    UPDATE_BY_ID: (id: number | string) => `/transactions/${id}`,
  },
  SETTINGS: {
