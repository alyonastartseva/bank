...
import {addToken, addUser, changeShowPassword, initialUser} from "@/app/store/slices/bankSlice.ts";
        ...
        >
            ...
            <div className={style.password}>
                ...
                <input
                    ...
                    onChange={event => addLoginInfo(event)}/>
                <img className={style.seePassword} src={seePassword} onClick={() => dispatch(changeShowPassword())}/>
            </div>
            <button type="submit" className={style.button} >
                Sign Up
            </button>
            <p className={style.regLink}>i'm a new user. <Link className={style.link} to='/sign-in' >Sign In</Link></p>
        </form>
    );
};
